...
class ScrumTimer: ObservableObject {
    ...
    static let speakerInitializer: ([String]) -> [Speaker] = { attendees in
        attendees.isEmpty ? [Speaker(name: "Player 1", isCompleted: false)] : attendees.map { Speaker(name: $0, isCompleted: false) }
    }
    ...
    init(lengthInMinutes: Int = 0, attendees: [String] = []) {
        ...
        self.speakers = ScrumTimer.speakerInitializer(attendees)
